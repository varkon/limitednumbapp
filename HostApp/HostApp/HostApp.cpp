                     ...
                     _In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_HOSTAPP, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_HOSTAPP));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_HOSTAPP);
